...
<!--背景遮罩--><div id='background' class='hidden'></div>
	...
	<ul>
		...
		<div id='right'>
			...
			<p class='title'><?php if($_GET["id"] == $_SESSION["uid"]): ?>我的<?php else: ?>Ta的<?php endif; ?>首页</p>

			<ul class='property'>
				<li>金币：<span><?php echo ($point); ?></span></li>
				<li>经验值：<span><?php echo ($exp); ?></span></li>
				<li>采纳率：<span><?php echo ($adopt); ?></span></li>
			</ul>
			<div class='list'>
				<p><span><?php if($_GET["id"] == $_SESSION["uid"]): ?>我的<?php else: ?>Ta的<?php endif; ?>提问 <b>(共<?php echo ($ask); ?>条)</b></span><a href="">更多>></a></p>
				<table>
					<?php if($myAsk): ?><tr>
							<th colspan='2' style="text-align:left" >标题</th>
							<th width='50'>回答数</th>
							<th width='150' class='t3'>更新时间</th>
						</tr>
						<?php if(is_array($myAsk)): foreach($myAsk as $key=>$v): ?><tr>
								<td class='t1'>
									<a title="<?php echo ($v["content"]); ?>" href="<?php echo U('Answer/index', array('id' => $v['id']));?>"><?php echo strCut($v['content'], 90);?></a>
								</td>
					...
					<?php else: ?>
						<tr height='140'><td>还没进行过提问</td></tr><?php endif; ?>
				</table>
			</div>
			<div class='list'>
				<p><span><?php if($_GET["id"] == $_SESSION["uid"]): ?>我的<?php else: ?>Ta的<?php endif; ?>回答 <b>(共<?php echo ($answer); ?>条)</b></span><a href="">更多>></a></p>
				<table>
					<?php if($myAnswer): ?><tr>
						...
						<?php if(is_array($myAnswer)): foreach($myAnswer as $key=>$v): ?><tr>
								<td width='500' class='t1'>
									<a href=""><?php echo strCut($v['content'], 80);?></a>
								</td>
								<td><span>[ <?php echo ($v["name"]); ?> ]</span></td>
								<td>20</td>
								<td class='t3'><?php echo time_to_date($v['time']);?></td>
