...
<head>
	...
	<title>修改头像-<?php echo (C("ask_title")); ?></title>
	...
	<link rel="stylesheet" href="/App/Ask/Public/Css/face.css">
	<script type="text/javascript">
		$(function(){
			$("form[name='uploadFace']").submit(function(){
	...
	<ul>
		...
		<div id='right'>
			...
			<div class='imgface_box'>
				<img src="<?php if($user_face): ?>/Uploads/Face/m_<?php echo ($user_face); else: ?> /App/Ask/Public/Images/profile_avatar.jpg<?php endif; ?>" id="preview">
				<form name='uploadFace' action="<?php echo U('Member/upFace');?>" method="POST" enctype="multipart/form-data">
					<input type="file" name="face" id="face" >
					<input id="sub" type="submit" value="确定修改">
				</form>
