...
<head>
	...
	<title>我要提问-<?php echo (C("ask_title")); ?></title>
	...
	<script type="text/javascript">
		var getCateUrl = "<?php echo U('Ask/getCate');?>";
		var getCheckCateNameUrl = "<?php echo U('Ask/getCheckCateName');?>";
		var point = 0;
		var login = false;
		<?php if(isset($_SESSION['uid']) && isset($_SESSION['ask_login_username'])): ?>var login = true;
			var point = <?php echo ($point); ?>;<?php endif; ?>
	</script>
	<script type="text/javascript" src="/App/Ask/Public/Js/ask.js"></script>
	<link rel="stylesheet" href="/App/Ask/Public/Css/ask.css" />
</head>
<body>
	<!-- top -->
	<!-- top -->
...
<!-- top结束 -->
	<div id='location'>
		<a href="/index.php/Ask">虎书问答</a>&nbsp;>&nbsp;提问
	</div>
	...
	<div id='center'>
		<div class='send'>
			<div class='title'>
				...
				<p class='right'>您还可以输入<span id='num'>100</span>个字</p>
			</div>
			<form action="<?php echo U('Ask/send');?>" id="send" method='post'>
				<div class='cons'>
				...
				<div class='reward'>
					...
					<ul>
						<li>
							<?php if(isset($_SESSION['uid']) and isset($_SESSION['username'])): ?>我的金币：<span><?php echo ($point); ?></span><?php endif; ?>
						</li>
						<li>
