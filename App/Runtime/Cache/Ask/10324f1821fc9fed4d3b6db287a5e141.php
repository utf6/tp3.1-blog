...
<!--背景遮罩--><div id='background' class='hidden'></div>
	...
	<ul>
		...
		<div id='right'>
			...
			<p class='lv-info'>恭喜您，已经升到 <span>Lv<?php echo ($level_info["lv"]); ?></span> 级啦，距下一级还需 <span><?php echo ($level_info["differ"]); ?></span> 经验值!</p>
			<div class='lv-rule'>
				<p><span>等级规则</span></p>
				<table class='lv-exp'>
					<tr>
					...
					<tr class="cur">
						<td >我的现在<span><?php echo ($level_info["lv"]); ?></span>级</td>
						<td><span><?php echo ($level_info["exp"]); ?></span></td>
					</tr>
					<tr>
						<td><?php echo ($level_info["nextLv"]); ?></td>
						<td><?php echo ($level_info["nextExp"]); ?></td>
					</tr>
				</table>
			</div>
			<div class='lv-rule'>
				...
				<table class='lv-exp'>
					...
					<tr>
						<td>每天登录</td>
						<td><?php echo (C("exp_login")); ?></td>
					</tr>
					<tr>
						<td>提问</td>
						<td><?php echo (C("exp_ask")); ?></td>
					</tr>
					<tr>
						<td>回答</td>
						<td><?php echo (C("exp_answer")); ?></td>
					</tr>
					<tr>
						<td>采纳与被采纳</td>
						<td><?php echo (C("exp_adopt")); ?></td>
					</tr>
				</table>
			</div>
		</div>
