...
<head>
	...
	<link rel="stylesheet" href="/App/Ask/Public/Css/index.css" />
	<script type="text/javascript">
		var verifyUrl = "<?php echo U('Regist/verify');?>/";
	</script>
			...
			<ul class='left-list'>
				<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><li class='list-l1'>
						<div class='list-l1-wrap'>
							...
							<ul class='list-l2'>
								<?php $__FOR_START_484340290__=0;$__FOR_END_484340290__=3;for($i=$__FOR_START_484340290__;$i < $__FOR_END_484340290__;$i+=1){ ?><li><a href="<?php echo U('List/index', array('id' => $v['child'][$i]['id']));?>"><?php echo ($v['child'][$i]['name']); ?></a></li><?php } ?>								
							</ul>
						</div>

						<div class='list-more hidden'>
							<ul>
								<?php $__FOR_START_1653002193__=3;$__FOR_END_1653002193__=count($v["child"]);for($i=$__FOR_START_1653002193__;$i < $__FOR_END_1653002193__;$i+=1){ ?><li><a href="<?php echo U('List/index', array('id' => $v['child'][$i]['id']));?>"><?php echo ($v['child'][$i]['name']); ?></a></li><?php } ?>	
							</ul>
						</div>
		...
		<div id='center'>
			<div id='animate'>
				<div class='imgs-wrap'>
					<ul>
						<li>
							<a href=""><img src="/App/Ask/Public/Images/animate1.jpg" width='558' height='190'/></a>
						</li>
						<li>
							<a href=""><img src="/App/Ask/Public/Images/animate2.jpg" width='558' height='190'/></a>
						</li>
						<li>
							<a href=""><img src="/App/Ask/Public/Images/animate3.jpg" width='558' height='190'/></a>
						</li>
					</ul>
				</div>
				<ul class='ani-btn'>
					<li class='ani-btn-cur'>虎书博客<i></i></li>
					<li>虎书问答<i></i></li>
					<li style='border:none'>虎书许愿墙<i></i></li>
				</ul>
			</div>
			...
			<dl class='answer-list'>
				<dt>
					...
					<a href='<?php echo U("List/index");?>'>更多>></a>
				</dt>
				<?php if(is_array($wait_solve_ask)): foreach($wait_solve_ask as $key=>$v): ?><dd>
						<a href="<?php echo U('Answer/index', array('id' => $v['id'], 'cid' => $v['cid']));?>"><?php echo strCut($v['content'], 66);?></a>
			...
			<dl class='answer-list'>
				<dt>
					...
					<a href='<?php echo U("List/index", array("type" => 2));?>'>更多>></a>
				</dt>
				<?php if(is_array($high_reward_ask)): foreach($high_reward_ask as $key=>$v): ?><dd>
						<a href="<?php echo U('Answer/index', array('id' => $v['id'], 'cid' => $v['cid']));?>"><b><?php echo ($v["reward"]); ?></b><?php echo strCut($v['content'], 66);?></a>
						<span><?php echo ($v["answer"]); ?>回答</span>
					</dd><?php endforeach; endif; ?>				
			</dl>
